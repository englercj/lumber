...
Webservice.prototype.log = function(args) {
    ...
    req.on('response', function(res) {
        ...
        res.on('end', function() {
            if(args.cb) args.cb(null, msg, args.level, self.name, self.url, res.statusCode, data);
        });

        res.on('close', function(err) {
            if(args.cb) args.cb(err, msg, args.level, self.name, self.url, res.statusCode, data);
        });
    });
