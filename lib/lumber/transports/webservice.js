...
var Webservice = exports.Webservice = function(options) {
    ...
    self.encoder = common.checkOption(options.encoder, 'json');
    self.level = common.checkOption(options.level, 'info');
    self.url = common.checkOption(options.url, null);
    self.method = common.checkOption(options.method, 'POST');
    self.headers = common.checkOption(options.headers, null);
    self.secure = common.checkOption(options.secure, false);
    self.auth = common.checkOption(options.auth, null);
