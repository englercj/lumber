...
var File = exports.File = function(options) {
    ...
    self.fileMode = options.fileMode || '0666';
    self.maxSize = options.maxSize || 52428800; //50MB
    self.rotate = options.rotate || 10;
