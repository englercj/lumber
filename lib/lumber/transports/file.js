...
var File = exports.File = function(options) {
    ...
    self.filename = common.checkOption(options.filename, path.resolve('app.log'));
    self.filemode = common.checkOption(options.filemode, '0666');
    self.maxsize = common.checkOption(options.maxsize, 52428800); //50MB
    self.rotate = common.checkOption(options.rotate, 10);
