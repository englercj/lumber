...
var Logger = exports.Logger = function(options) {
    ...
    self.transports = options.transports || [];

    //create functions for log levels
    Object.keys(self.levels).forEach(function(key) {
	self[key] = function() {
	    var args = Array.prototype.slice.call(arguments).unshift(key);
	    args.unshift(key);
...
Logger.prototype.log = function() {
    var self = this,
    args = common.prepareArgs(Array.prototype.slice.call(arguments));
